...
import { GlobalSearch } from "../../common/searchBar";
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-4">
        ...
        <h1 className={`text-xl font-bold capitalize text-primary ${pageTitle !== "Dashboard" ? "hidden sm:block" : ""}`}>
  {pageTitle}
</h1>
      </div>
      ...
      <div className="flex items-center gap-3">
        ...
        (
          ...
          <Button className="bg-primary hover:bg-primary/90 text-black font-bold rounded-full px-5">
            ...
            <span className="hidden sm:inline">Connect Binance</span>
          </Button>
        </Link>
        )  : <></>
      }
