import { PortfolioStats, AssetAllocationItem, RecentTransactionItem, MarketCoinItem, SmartAlertItem } from '@/types/index';

// this  file is mock data
import { mockStats } from '@/lib/mock/portfolio'
import { mockMarket } from '@/lib/mock/market'
import { mockTransactions } from '@/lib/mock/transactions'
import { mockAllocation } from '@/lib/mock/allocation'
import { mockAlerts } from '../mock/alert';

 export const dashboardApi = {
    // Portfolio stats from Supabase
